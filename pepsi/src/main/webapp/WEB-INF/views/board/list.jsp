								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="h5 mb-0 font-weight-bold text-gray-800 mb-1">${vo.name}</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">${vo.writedate}</div>
										</div>
										<div class="col-auto">
...
<div class="row row-cols-4">
	...
	<div class="col border  p-0">
		...
		<div class="m-2"><a onclick="fn_info( ${vo.id} )" >${vo.title}</a></div>
		<div class="m-2">${vo.name}</div>
		<div class="m-2">${vo.writedate}
				<c:if test="${vo.filecnt gt 0}">
				<span style='float: right'><i class="text-danger fa-solid fa-paperclip"></i></span>
				</c:if>
		</div>
